...
import {searchByPage,findUserByUserName} from '../User/UserService'
...
class SelectUserPopup extends React.Component {
  constructor(props) {
    super(props);
  ...
  search() {
    this.setState({ page: 0 }, function () {
        var searchObject = {};
        searchObject.text = this.state.keyword ? this.state.keyword:"";
    ...
    return (
      <Dialog onClose={handleClose} open={open} PaperComponent={PaperComponent} maxWidth={'md'} fullWidth>
        <DialogTitle style={{ cursor: 'move' }} id="draggable-dialog-title">
          <span className="mb-20">{t("user.userList")}</span>
        </DialogTitle>
        <DialogContent>
